...
func (c *storageClient) Upload(ctx context.Context, opts ...grpc.CallOption) (Storage_UploadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Storage_ServiceDesc.Streams[0], "/Storage/Upload", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *storageUploadClient) CloseAndRecv() (*UploadRsp, error) {
...
func (x *storageUploadServer) SendAndClose(m *UploadRsp) error {
