...
func (x *SignUpRsp) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *AuthBasicReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthBasicReq) ProtoMessage() {}

func (x *AuthBasicReq) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_user_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthBasicReq.ProtoReflect.Descriptor instead.
func (*AuthBasicReq) Descriptor() ([]byte, []int) {
	return file_user_proto_user_proto_rawDescGZIP(), []int{2}
}

func (x *AuthBasicReq) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *AuthBasicReq) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *AuthBasicRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthBasicRsp) ProtoMessage() {}

func (x *AuthBasicRsp) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_user_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthBasicRsp.ProtoReflect.Descriptor instead.
func (*AuthBasicRsp) Descriptor() ([]byte, []int) {
	return file_user_proto_user_proto_rawDescGZIP(), []int{3}
}

func (x *AuthBasicRsp) GetAllow() bool {
	if x != nil {
		return x.Allow
	}
	return false
...
var file_user_proto_user_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x55,
	...
	0x6d, 0x65, 0x22, 0x24, 0x0a, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x55, 0x70, 0x52, 0x73, 0x70, 0x12,
	0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x40, 0x0a, 0x0c, 0x41, 0x75, 0x74, 0x68,
	0x42, 0x61, 0x73, 0x69, 0x63, 0x52, 0x65, 0x71, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69,
	...
	,
...
var file_user_proto_user_proto_goTypes = []interface{}{
	...
	(*SignUpRsp)(nil),    // 1: SignUpRsp
	(*AuthBasicReq)(nil), // 2: AuthBasicReq
	(*AuthBasicRsp)(nil), // 3: AuthBasicRsp
}
var file_user_proto_user_proto_depIdxs = []int32{
	0, // 0: User.SignUp:input_type -> SignUpReq
	2, // 1: User.AuthBasic:input_type -> AuthBasicReq
	1, // 2: User.SignUp:output_type -> SignUpRsp
	3, // 3: User.AuthBasic:output_type -> AuthBasicRsp
